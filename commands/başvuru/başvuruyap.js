...
module.exports = class AnonsCommand extends Command {
    ...
    run(message, args) {
        ...
        if (!kanal) return message.reply(`Başvuru kanalını bulamıyorum.Bu yüzden başvuru sistemi devre dışıdır.\nAçmak için \`başvuru-kanal-ayarla\` komutu ile bir başvuru kanalı belirleyin.`);
    
        message.reply(`Başvurunuz gönderildi, en kısa zamanda size geri dönüş yapılacaktır.`);
